...
//         when(categoryService.updateCategoryById(categoryId, any(Category.class))).thenReturn(updatedCategory);
...
//         verify(categoryService, times(1)).updateCategoryById(categoryId, any(Category.class));
//     }
...
//         assertEquals(HttpStatus.NOT_FOUND, responseEntity.getStatusCode());
//         verify(categoryService, times(0)).updateCategoryById(categoryId, any(Category.class));
//     }
